                        ...
                        if edit_request:
                            ...
                            try:
                                ...
                                if whatsapp_result["success"]:
                                    ...
                                    logger.error(f"Failed to send edited response verification message: {whatsapp_result['error']}")
                                    return {
                                        "status": "error",
                                ...
                                await whatsapp_service.send_message(normalized_phone, fallback_message)
