...
INSERT INTO public.subscription_plans (stripe_product_id, name, description, monthly_price_cents, max_salespeople) VALUES
  ...
  ('prod_Sz7Wz92o80HyIb', 'Test Product', 'Free testing plan', 0, NULL)
...
-- Timestamp update triggers (drop and recreate to avoid conflicts)
...
DROP TRIGGER IF EXISTS trg_touch_dealership_subscriptions_updated_at ON public.dealership_subscriptions;
